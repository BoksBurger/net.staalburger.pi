...
function loadCalulation(){
    var init_radius = "cm";
    var init_diameter = "cm";
    var init_circumference = "cm";
    var init_area = "cm2";
    $("#resetCalculation").click(function () {
        init_radius = "cm";
        init_diameter = "cm";
    ...
    $(".unit-menu li a").click(function () {
        let id = $(this).parents("ul").attr("aria-labelledby");
        $("#" + id).html($(this).data('value'));
        $("#" + id).val($(this).data('value'));
    });

    $(".unit-menu li a").click(function () {
        let id = $(this).parents("ul").attr("aria-labelledby");
        let popupid = $(this).parents("div").attr("id");
        $("#" + popupid).popup("close");
        console.log("#" + popupid);
        if (id == "radius_unit") {
